        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="{{asset(auth()->user()->avatar ? asset('storage/' . auth()->user()->avatar): asset('/img/avatar.png'))}}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-xl-4">
          <div class="card h-100">
            <div class="card-header pb-0 p-3">
              <div class="row">
                ...
                <div class="col-md-4 text-end">
                  <a href="/information/{{auth()->user()->id}}/edit">
            ...
            <div class="card-body p-3">
              <p class="text-sm">
                Hi, I’m {{auth()->user()->username}}, {{auth()->user()->description}}
              </p>
              <hr class="horizontal gray-light my-4">
              <ul class="list-group">
                <li class="list-group-item border-0 ps-0 pt-0 text-sm"><strong class="text-dark">Full Name:</strong> &nbsp; {{auth()->user()->fullName}}</li>
                <li class="list-group-item border-0 ps-0 text-sm"><strong class="text-dark">Mobile:</strong> +254 {{auth()->user()->phone}}</li>
